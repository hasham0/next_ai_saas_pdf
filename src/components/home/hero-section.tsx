...
const HeroSection = () => {
  return (
    <section className="animate-in relative z-0 container mx-auto flex max-w-7xl flex-col items-center justify-center px-4 py-16 transition-all sm:py-20 lg:px-12 lg:py-28">
      <div className="animate-gradient-x group relative overflow-hidden rounded-full border border-rose-400 bg-gradient-to-r from-rose-200 via-rose-500 to-rose-800 p-[1px]">
        <Badge
          variant="secondary"
